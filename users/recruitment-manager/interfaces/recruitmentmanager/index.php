...
<body>
    <div class="main-container">
        ...
        <div class="side-container" id="side-container">
            ...
            <div class="avatar"><img src="./assets/recmanager-dp.png" alt="Avatar"></div>
            <div class="name">Hello Fiona!</div>
            <div class="buttons">
        ...
        <div class="content" id="content">
            ...
            if (!empty($_GET["Page"])) {
                ...
                unset($pages_folder[12], $pages_folder[13], $pages_folder[18], $pages_folder[19]);
                // echo "<pre>";
                // print_r($pages_folder);
                // echo "</pre>";
