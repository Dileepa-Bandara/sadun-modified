    ...
    <div class="sales-boxes">
        <div class="recent-sales">
          ...
          <div class="card">
              <h1>Employee Handbook</h1><br>
                <p>Document that communicates your company's mission, policies and expectations</p><br>
        ...
        <div class="ushi">
          <div class="card">
              ...
              <p>Written invitation sent to a candidate, applicant, or a job aspirant inviting him/her</p><br>
        ...
        <div class="ushi">
          <div class="card">
              ...
              <p>Documented form which states the employment confirmation.</p><br>
              <input type="button" value="Download">       
          </div>
        </div> 
        <div class="ushi">
          <div class="card">
              ...
              <p>Describes the general tasks, or other related duties, and responsibilities of a position.</p><br>
              <input type="button" value="Download">       
          </div>
        </div> 
        <div class="ushi">
          <div class="card">
              ...
              <p>Letter that lets an employee know that they have been promoted to a new position within the same company.</p><br>
              <input type="button" value="Download">       
          </div>
        </div> 
