...
<head>
    ...
    <link rel="stylesheet" href="./interfaces/admin/index.css">
...
<body>
    <div class="main-container">
        ...
        <div class="side-container" id="side-container">
            ...
            <div class="avatar"><img src="./assets/admin-dp.png" alt="Avatar"></div>
            <div class="name">Hello Priya!</div>
            <div class="buttons">
                ...
                <!-- <button class="dropButton">Manage Employees</button>
                <div class="drop-content">
                    <a href="index.php?Page=remainingLeave.php">Add Employee</a>
                    <a href="index.php?Page=pendingLeave.php">View Employee Details</a>
                </div>     -->
                <button class="dropButton"><a href="index.php?Page=userRole.php">User Roles</a></button>
                <button class="dropButton"><a href="index.php?Page=departments.php">Departments</a></button>
